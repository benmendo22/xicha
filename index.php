	...
	<body>
		...
		<section id="left-side">
			...
			<div class="social-icons">
				...
				<a href="https://www.facebook.com/xichabrewing"><i class="fa fa-facebook"></i></a>
				<a href="https://www.instagram.com/xicha.brewing"><i class="fa fa-instagram"></i></a>
				<a href="https://www.twitter.com/xichabrewing"><i class="fa fa-twitter"></i></a>
						...
						<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" class="col-xs-12 col-sm-6 col-lg-6 clear-second">
							...
							<figcaption itemprop="caption description">
								...
								<div class="photo-details">
									...
									<h4>Cerveza [ser-ve-sah]</h4>

									<span class="border"></span>

									<p>Being based in the Pacific Northwest, we recognize the power of ales and intend to accomodate the hop-driven palate. However, we strive to honor the culture of the Americas with lager-based beers.</p>
		...
		<div id="somedialog" class="dialog">
			...
			<div class="dialog__content">
				...
				<div class="dialog-inner">
					...
					<p>Being the first to know always feels great... Signing up to our newsletter gives you <strong>exclusive access to our Soft Opening!</strong></p>
